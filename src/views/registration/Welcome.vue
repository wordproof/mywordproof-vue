<template>
  <div class="flex flex-col items-center bg-blue h-full px-10 py-20">
    <svg
      width="47px"
      height="47px"
      viewBox="0 0 47 47"
    ...
    >
      ...
      >
        <g
          id="Wordproof---Register-A-Account-created"
    ...
    <h2 class="text-white mt-8">Hi Jelle</h2>
    <h2 class="text-white">Welcome to wordproof</h2>
    <p class="text-white">Your account has been created</p>
    <a class="text-white mt-10" href="">Get started &#8594;</a>
  </div>
</template>
